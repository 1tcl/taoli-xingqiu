...
class MainActivity : AppCompatActivity() {
    ...
    fun showPaymentDialog(prefillAmount: Double = 0.0, prefillNote: String = "") {
        ...
        val amountInput = view.findViewById<android.widget.EditText>(R.id.pay_amount)
        val noteInput = view.findViewById<android.widget.EditText>(R.id.pay_note)
        ...
        for (cat in categories) {
            val chip = Chip(this).apply {
                ...
                chipBackgroundColor = getColorStateList(android.R.color.white)?.withAlpha(255)
                setOnClickListener {
                    selectedType = cat
